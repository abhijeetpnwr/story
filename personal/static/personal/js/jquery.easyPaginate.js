    ...
    return this.each (function (instance) {
        ...
        var displayNav = function() {
            ...
            if(plugin.settings.firstButton) {
                htmlNav += '<center><ul class="pagination"><li><a href="#'+plugin.settings.hashPage+':1" title="First page" rel="1" class="first">'+plugin.settings.firstButtonText+'</a></li>';
            }
            ...
            if(plugin.settings.lastButton) {
                htmlNav += '<li><a href="#'+plugin.settings.hashPage+':'+plugin.settings.pages+'" title="Last page" rel="'+plugin.settings.pages+'" class="last">'+plugin.settings.lastButtonText+'</a></li></ul>';
            }
